  ...
  reducers: {
    setUser: (
      ...
      if (
        ...
        payload.profile_picture.startsWith("/") &&
        PUBLIC_URL
      ) {
    ...
    setDefaultAddress: (
      state,
      action: PayloadAction<{ addressId: number; type: string }>
    ) => {
    ...
    saveSelectedAddress: (
      state,
      action: PayloadAction<{ selectedAddress: Address }>
    ) => {
...
// In your userSlice (or wherever you handle logout)

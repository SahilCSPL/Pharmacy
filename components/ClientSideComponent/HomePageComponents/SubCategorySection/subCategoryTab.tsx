    ...
    <section className="container mx-auto py-4 lg:py-5" id="our-category">
      <div className="container mx-auto">
        ...
        <div
          ...
          className="flex flex-nowrap border-b lg:justify-center overflow-x-auto hiddenScrollbar"
        >
          {categories.map((category) => (
            <button
              ...
              className={`p-4 text-sm lg:text-base xl:text-xl font-semibold focus:outline-none focus:ring focus:ring-[--mainColor] transition duration-300 ease-in-out 
                ${
        ...
        {/* Tab Content: Render all panels and hide the inactive ones */}
        {categories.map((category) => {
          ...
          return (
            <div
              ...
              hidden={!isActive}
              className="mt-4 flex flex-wrap lg:flex-no-wrap"
            >
